#!/usr/bin/env python3
"""
Tests the web server end-points.
"""
import requests
...
def register_user(email: str, password: str) -> None:
    """
    Test for registering a user with email and password.
    Args:
...
def log_in(email: str, password: str) -> str:
    """
    Test for login with correct email and password.
    Args:
        email: The user's email.
        password: The user's password.
    Returns:
...
def log_out(session_id: str) -> None:
    """
    Test for logout with session_id.
    Args:
        session_id
    Returns:
        None
...
def reset_password_token(email: str) -> str:
    """
    Test for reset password token with email.
    Args:
        email
    Returns:
...
def update_password(email: str, reset_token: str,
    ...
    """
    Test for update password with email,
